...
func home(res http.ResponseWriter, req *http.Request) {
	...
	if req.FormValue("formtext") != "" {
		...
		cook.Val = formtext + `|` + makehmac(formtext)
	}
	...
	io.WriteString(res, `<!DOCTYPE html>
  	<html>
  	  <body>
  	    ...
  	    <a href="/authen">Validate This HMAC</a>
  	  </body>
  	</html>`)

}

func authen(res http.ResponseWriter, req *http.Request) {
